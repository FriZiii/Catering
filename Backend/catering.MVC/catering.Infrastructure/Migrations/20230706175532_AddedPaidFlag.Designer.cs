...
namespace catering.Infrastructure.Migrations
{
    ...
    [Migration("20230706175532_AddedPaidFlag")]
    partial class AddedPaidFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("catering.Domain.Entities.User.AppUser.DeliveryAdress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("catering.Domain.Entities.Guest", b =>
                {
                    b.HasOne("catering.Domain.Entities.User.AppUser.DeliveryAdress", "DeliveryAdress")
                        .WithMany()
            ...
            modelBuilder.Entity("catering.Domain.Entities.OrderEntities.Order", b =>
                {
                    ...
                    b.HasOne("catering.Domain.Entities.Guest", "Guest")
                        .WithMany()
